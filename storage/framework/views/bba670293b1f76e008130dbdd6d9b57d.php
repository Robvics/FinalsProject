...
.font-bold {
   ...
   <form wire:submit.prevent="saveproduct">
    ...
    <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['supplierID'];
...
<thread>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <img src="<?php echo e(asset('uploads/product-images/'. $product->file_path)); ?>" style="width:50px">
            </td>
            <td>
            ...
            <td>
                <button wire:click='toggleEditProduct(<?php echo e($product ->id); ?>)'>Edit</button>
                <button wire:click='DeleteProduct(<?php echo e($product ->id); ?>)'>Delete</button>
            </td>
        </tr>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
...
<?php /**PATH C:\Users\Rabikk\Desktop\SampleApp\resources\views/livewire/admin/products.blade.php ENDPATH**/ ?>